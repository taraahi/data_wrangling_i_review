Data Wrangling I Review - Data Manipulation
================
...
look up `?select_helpers`, look at *starts\_with*, *ends\_with*,
*contains*, *everything*
...
You can just look at the one column of interest and keep everything else
to the right.
...
New function in dplyer `relocate` does the same thing (but we usually
use select).
...
double equal because asking question of equality, not saying it equals
20.
...
How much did they gain over the course of their pregnancies? Can create
and modify variables at the same time- added wait gain and made
variables lowercase.
...
USE THE PIPE OPERATOR INSTEAD *shift command m*

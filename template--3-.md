Data Wrangling I Review - Data Import
================
...
We’re focusing on the `readr` package. We put the `readxl` package in
later. Also haven.
...
```
    ...
    ## [1] "/Users/simstar44-music/Desktop/data_wrangling_i_review"
...
It’s telling us we have 49 rows and 8 columns, it’s a tibble, variable
names have been converted to snakecase compared to before.
...
Can type `view` in the CONSOLE. It opens up another window to see full
dataset.
